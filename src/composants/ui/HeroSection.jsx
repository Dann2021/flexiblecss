  ...
  return (
    <Col className={"ai-mil mh-10"}>
      ...
      <Bloc type={"myn"} nombre={col} className="col ai-mil  slidebas gap-3 relative">
        <TexteDegrade
          className="texte-9  lh-2 ls-2 ta-mil te-noir mh-3"
        ...
        <div className="aff-flex ai-mil gap-2 jc-mil mh-1">
          <Bouton taille={"me"} as={Link} to={"/docs/intro"} type={"primaire"} className={"bouton-icone"} >
          <FaRocket />
          {btn1}</Bouton>
          <Bouton taille={"me"} as={Link} to={"/docs/install"} theme={"sombre"} className={"bouton-icone"} >
         <FaGithub />
          {btn2}
          </Bouton>
        </div>
